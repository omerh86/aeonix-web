...
Contact.createExternal = function (displayName, numbers, img = "img/user-placeholder.png") {
...
Contact.compareContactsByName = function (contact1, contact2) {
    var name1 = contact1.getName().toLowerCase();
    var name2 = contact2.getName().toLowerCase();
    if (name1 < name2)
        return -1;
    if (name1 > name2)
        return 1;
